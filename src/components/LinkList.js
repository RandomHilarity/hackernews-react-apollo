    ...
    <Query query={FEED_QUERY} variables={_getQueryVariables(props)}>
      {({ loading, error, data, subscribeToMore }) => {
        ...
        const pageIndex = props.match.params.page ?
          (props.match.params.page - 1) * LINKS_PER_PAGE : 0;
          ...
          <Fragment>
            ...
            {isNewPage && (
              <div className="flex ml4 mv3 gray">
                <div className="point mr2" onClick={ _previousPage }>Previous</div>
                <div className="pointer" onClick={ _nextPage(data)}>Next</div>
              </div>
            )}
          </Fragment>
        )
